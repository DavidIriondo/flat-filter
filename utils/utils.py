...
def get_regex_rules():
    ...
    rules = {
        ...
        "1 de septiembre de 2024 hasta 30 de junio 2025" : rf"[0-9]+\s*de\s*{format_months_for_regex()}\s*(|de)\s*[0-9]+\s*(a|hasta|hasta el)\s*[0-9]+\s*de\s*{format_months_for_regex()}\s*[0-9]+", 
        "1 de septiembre hasta 30 de junio 2025" : rf"[0-9]+\s*de\s*{format_months_for_regex()}\s*(a|hasta|hasta el)\s*[0-9]+\s*de\s*{format_months_for_regex()}\s*[0-9]+", 
